...
const AppRoutes = () => (
  <Routes>
    ...
    <Route path="/cases/:caseId/close" element={<Protected element={<CaseClosureView />}    role={['VICTIM','PSYCHOLOGIST','DEFENDER']} />} />
    <Route path="/cases/:caseId/log" element={<Protected element={<CaseLogPage />}      role={['PSYCHOLOGIST','DEFENDER','ADMIN']} />} />
    ...
    <Route path="/calendar"           element={<Protected element={<CalendarView />}       role={['VICTIM','PSYCHOLOGIST','DEFENDER','ADMIN']} />} />
