...
export const HelpPage = () => {
  return (
    <div className="w-full px-8 py-8 pb-16">
      {/* Header */}
      <div className="mb-12">
        <h1 className="text-4xl font-bold text-gray-900 mb-3">Ayuda Inmediata y Directorio de Emergencia</h1>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-12">
        ...
        <div className="bg-white rounded-lg border-l-4 border-red-500 p-8 shadow-sm hover:shadow-md transition">
          <div className="flex items-center gap-3 mb-4">
            ...
            <h2 className="text-2xl font-bold text-gray-900">Línea de Emergencia</h2>
          </div>
        ...
        <div className="bg-white rounded-lg border-l-4 border-teal p-8 shadow-sm hover:shadow-md transition">
          <div className="flex items-center gap-3 mb-4">
            ...
            <h2 className="text-2xl font-bold text-gray-900">Línea de la Mujer</h2>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <div className="border border-gray-200 rounded-lg p-6 hover:border-teal transition">
            <div className="flex items-center gap-3 mb-4">
              ...
              <h3 className="font-bold text-gray-900">Comisaría de la Familia</h3>
            </div>
          ...
          <div className="border border-gray-200 rounded-lg p-6 hover:border-teal transition">
            <div className="flex items-center gap-3 mb-4">
              ...
              <h3 className="font-bold text-gray-900">Hospital Regional</h3>
            </div>
            <p className="text-sm text-gray-600 mb-3">Calle Hospilario s/n</p>
            <div className="flex items-center gap-2 text-teal mb-4">
              <Phone className="w-4 h-4" />
              <span className="text-sm font-medium">Urgencias inmediatas</span>
            </div>
            <button className="text-teal font-medium text-sm hover:underline flex items-center gap-1">
              Cómo llegar →
            </button>
          ...
          <div className="border border-gray-200 rounded-lg p-6 hover:border-teal transition">
            <div className="flex items-center gap-3 mb-4">
              ...
              <h3 className="font-bold text-gray-900">CEM (Centro Emergencia Mujer)</h3>
            </div>
            <p className="text-sm text-gray-600 mb-3">Jr. de la Paz 123, Mezzanine</p>
            <div className="flex items-center gap-2 text-teal mb-4">
              <span className="text-xs font-medium">Lun - Vie: 08:00 - 18:00</span>
            </div>
            <button className="text-teal font-medium text-sm hover:underline flex items-center gap-1">
              Más información →
            </button>
      ...
      <div className="bg-gradient-to-r from-teal to-teal/80 text-white rounded-lg p-12 mb-12">
        ...
        <p className="text-teal-light mb-6">
          Recuerda que no estás sola. Estos servicios están diseñados para brindarte protección legal, médica y psicológica inmediata. 
      ...
      <div className="bg-gradient-to-b from-gray-100 to-gray-50 rounded-lg p-12 text-center">
        ...
        <h3 className="text-2xl font-bold text-gray-900 mb-3">Explorar Centros de Ayuda</h3>
        <p className="text-gray-600">
          Ubicación actualizada y servicios disponibles en tu zona. Todos nuestros centros asociados cumplen con estándares internacionales 
