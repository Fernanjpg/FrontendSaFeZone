  ...
  return (
    <div className="w-full px-8 py-8 pb-32">
      ...
      <div className="bg-gradient-to-r from-teal to-teal/80 text-white rounded-2xl p-8 mb-8">
        <h2 className="text-3xl font-bold mb-2">Bienvenido, {userData?.name || 'Legal Defender'}</h2>
        <p className="text-teal-light">Panel de gestión legal. Supervisa tus casos activos y audiencias programadas.</p>
          ...
          <table className="w-full text-sm">
            <thead>
              <tr className="border-b border-gray-200">
                ...
                <th className="text-left py-3 px-4 font-medium text-gray-700">Juzgado / Sala</th>
              </tr>
            </thead>
            <tbody>
      ...
      <div className="bg-white rounded-xl shadow-sm p-6 mb-8">
        ...
        <div className="space-y-3">
          <div className="border-l-4 border-yellow-500 pl-4 py-2 bg-yellow-50/50">
            ...
            <p className="text-sm text-gray-800 mt-1">Revisar precedentes de jurisprudencia en casos similares para la audiencia de este viernes.</p>
          </div>
          <div className="border-l-4 border-blue-500 pl-4 py-2 bg-blue-50/50">
            <p className="text-xs text-blue-700 font-medium">ESTADO</p>
            <p className="text-sm text-gray-800 mt-1">Actualización de jurisprudencia de derechos humanos cargada.</p>
          </div>
        </div>
      </div>
      ...
      <div className="mt-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
          <div className="bg-white rounded-lg p-4 border-l-4 border-teal hover:shadow-md transition">
            ...
            <p className="text-sm text-gray-600">Acceso a fallos y precedentes relevantes</p>
          </div>
          ...
          <div className="bg-white rounded-lg p-4 border-l-4 border-accent hover:shadow-md transition">
            ...
            <p className="text-sm text-gray-600">Consultas para casos complejos</p>
          </div>
        </div>
      </div>
