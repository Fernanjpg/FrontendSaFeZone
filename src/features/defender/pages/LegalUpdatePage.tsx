...
export const LegalUpdatePage = () => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    if (!formData.date || !formData.time) {
      setError('Por favor completa la fecha y hora de la actualización')
      return
    }
    
    if (!formData.court.trim()) {
      setError('El juzgado o entidad no puede estar vacío')
      return
    }
    
    if (!formData.outcome.trim()) {
      setError('La descripción del resultado no puede estar vacía')
      return
    }
    
    // Guardar actualización legal en sessionStorage
    ...
    alert('✓ Actualización legal guardada')
    ...
    <div className="w-full px-8 py-8 pb-16">
      ...
      <div className="mb-8">
        ...
        <p className="text-gray-600">
          Registra actualizaciones críticas, resultados de audiencias y cambios procedimentales para mantener la integridad del expediente de protección.
        </p>
      </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="bg-white rounded-lg p-6 shadow-sm">
              ...
              >
                ...
                <option value="presentacion">Presentación Legal</option>
                <option value="orden">Orden de Protección</option>
                <option value="investigacion">Actualización de Investigación</option>
              </select>
            </div>
            ...
            <div className="bg-white rounded-lg p-6 shadow-sm">
              ...
              <input
                ...
                placeholder="Ej. Corte Superior de Justicia, Distrito 4"
                className="w-full px-4 py-2 border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-teal"
                required
              />
            </div>
            ...
            <div className="bg-white rounded-lg p-6 shadow-sm">
              ...
              <textarea
                ...
                placeholder="Identifica acciones inmediatas requeridas..."
                className="w-full px-4 py-3 border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-teal h-32 resize-none"
              />
            </div>
            ...
            <div className="bg-red-50 rounded-lg p-6 border border-red-200">
              ...
              <p className="text-xs text-red-800 mt-2">
                Toda la información ingresada aquí es confidencial y sujeta a secreto profesional abogado-cliente y doctrina de trabajo. 
                Asegúrate que todos los detalles sean apropiados para registro legal oficial.
              </p>
            </div>
          ...
          <div className="bg-white rounded-lg p-6 shadow-sm">
            ...
            <div className="space-y-3">
              <div>
                ...
                <p className="text-sm text-gray-900">Reporte de Acoso Laboral</p>
              </div>
              <div>
              ...
              <div>
                ...
                <p className="text-sm text-gray-600">
                  Patrones sistémicos de abuso verbal reportados dentro del departamento clínico. Paciente busca protección formal y reasignación.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white rounded-lg p-6 shadow-sm">
            ...
            <div className="space-y-4">
              <div className="border-l-2 border-teal pl-4">
                <p className="text-xs text-gray-500">12 de mayo de 2026</p>
                <p className="text-sm font-medium text-gray-900">Primera denuncia presentada</p>
              </div>
              <div className="border-l-2 border-gray-300 pl-4">
                <p className="text-xs text-gray-500">15 de mayo de 2026</p>
            ...
            <div className="flex gap-3">
              ...
              <div>
                ...
                <p className="text-xs text-blue-800">
                  Asegúrate que toda documentación cumpla con requisitos procedimentales y normativas legales locales para admisibilidad.
                </p>
              </div>
            </div>
          </div>
