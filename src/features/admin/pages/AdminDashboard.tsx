...
const QUICK_ACTIONS = [
  {
    ...
    description: 'Revisar y asignar reportes pendientes',
    path: '/admin/triage',
    icon: ClipboardList,
    color: 'bg-rose-500',
  },
  {
    ...
    description: 'Administrar administradores y gerentes',
    path: '/admin/users',
    icon: Users,
    color: 'bg-blue-500',
  },
  {
    ...
    description: 'Casos de alta prioridad no atendidos',
    ...
    <div className="p-6 space-y-8">
      ...
      <div>
        ...
        <p className="text-gray-500 mt-1">
          Bienvenido, <span className="font-medium text-gray-700">{user?.name}</span>. Aquí está el resumen del sistema.
        </p>
      </div>
